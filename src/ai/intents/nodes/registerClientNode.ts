...
type RegisterClientNodeOptions = {
  systemInstructionCreateClient: string;
};

export const registerClientNode = ({
  systemInstructionCreateClient,
}: RegisterClientNodeOptions): GraphNode<typeof State> => {
  return async (state) => {
